...
Het Analyse-tabblad gebruikt opgeslagen voorspelde kwartierprijzen en later gepubliceerde Home Assistant-tarieven uit dezelfde entiteit-, prijsveld- en eenheidsreeks. Een dag vooruit bekend tarief mag al meetellen voordat het kwartier is afgelopen. Per lokale dag wordt één representatieve run gekozen. Historische kalibratie leest uitsluitend prijsrevisies die op het relevante uitgiftetijdstip gepubliceerd waren. Een empirische bandbreedte mag pas worden getoond na voldoende oudere onafhankelijke dagen; evaluatie van de dekking gebruikt latere runs dan de kalibratiegegevens. Het aantal kwartieren en afzonderlijke dagen wordt bij de uitkomst vermeld. Een gemeten dekking uit het verleden is geen garantie voor toekomstige dekking.
