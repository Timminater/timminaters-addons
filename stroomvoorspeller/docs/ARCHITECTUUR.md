...
De App schrijft naar haar eigen database. Alle uitgaande HA-verzoeken zijn GET. Alleen bij Open-Meteo-keuze wordt een externe weer-GET gedaan. Er worden geen privégegevens gepubliceerd. Een lokale browser moet via Ingress openen om de JSON-routes te bereiken.
